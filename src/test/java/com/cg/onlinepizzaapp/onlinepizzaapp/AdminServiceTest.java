...
class AdminServiceTest {
	...
	void signIn() 
	{
		...
		when(dao.findByAdminNameAndAdminPassword("Swagat","Jena")).thenReturn(Optional.of(admin));
		Admin admincheck=service.signIn("Swagat","Jena");
		assertEquals("Swagat",admincheck.getAdminName());
	}
	@Test
	void addNewAdmin()
	{
