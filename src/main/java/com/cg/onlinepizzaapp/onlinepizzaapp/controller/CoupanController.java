...
public class CoupanController {
	...
	Coupan viewCoupan(@PathVariable("coupanId") int coupanId)  throws CoupanIdNotFoundException{
	...
	Coupan deleteCoupan(@PathVariable int coupanId) throws CoupanIdNotFoundException {
		return service.deleteCoupans(coupanId);
